...
public class G_Enemy_Spawn : Gimick
{
    //PlayerSensor継承
    [SerializeField]
    ...
    [SerializeField]
    private AudioSource spawnSE,destSE;
    [SerializeField]
    ...
    [System.Serializable]
    public class LevelObject : LevelValue<GameObject> {
    ...
    {
        _HP -= AttackMagic.Damage;
        base.GetDamage(value, Attackele == Weakele);
    }
}